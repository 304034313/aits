...
- WebElement: POM 单点维护，联动更新 WebPage.pom_code（仅 web_testing 已安装时注册）
"""
import logging
...
def _connect_web_testing_signals():
    """API-only 等裁剪包未安装 web_testing 时，避免 signals.E001 系统检查失败。"""
