...
class LLMConfigurationSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = [
            'id', 'model_type', 'model_type_display', 'provider', 'provider_display', 'is_active', 'is_default',
...
class RAGConfigurationSerializer(serializers.ModelSerializer):
    ...
    embedding_load_mode_display = serializers.CharField(source='get_embedding_load_mode_display', read_only=True)
    
    class Meta:
        model = RAGConfiguration
        fields = [
            'id', 'name', 'is_active', 'is_default', 'vector_db_type', 'vector_db_type_display',
            'embedding_model', 'embedding_load_mode', 'embedding_load_mode_display',
            'embedding_model_local_path', 'chunk_size', 'chunk_overlap',
