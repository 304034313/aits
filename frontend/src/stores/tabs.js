...
const ROUTE_TITLE_MAP = {
  ...
  '/perf-testing/dashboard': '性能大盘',
  '/perf-testing/scenarios': '压测场景',
  '/perf-testing/config': '发压配置',
  '/perf-testing/monitor': '任务监控',
  '/perf-testing/reports': '测试报告',
  '/project/project-list': '项目列表',
  '/project/environments': '环境管理',
  '/api-testing/environments': '环境管理',
  '/web-testing/environments': '环境管理',
  '/app-testing/environments': 'Agent 管理',
  ...
  '/app-testing/test-suites': '测试套件管理',
