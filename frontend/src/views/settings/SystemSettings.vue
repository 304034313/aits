<template>
  <div class="config-portal">
    <div class="config-header">
      ...
      <p class="config-desc">邮件服务、消息渠道、通用参数与工作区菜单</p>
    </div>
...
<script setup>
import { Message, Bell, Operation, Grid } from '@element-plus/icons-vue'
...
.config-card.card-menu .card-glow-bar {
