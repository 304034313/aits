      ...
      <div v-else class="card-header">
        ...
        <div class="card-header-right">
          ...
          <div class="card-header-filters">
            <el-select v-if="!lockedSuiteType" v-model="filters.suite_type" placeholder="测试类型" clearable @change="loadTasks" style="width: 120px;">
...
const MODULE_SUITE_TYPE_MAP = { api: 'api', web: 'web', app: 'app' }
const currentModule = computed(() => route.matched.find(r => r.meta?.module)?.meta?.module)
const lockedSuiteType = computed(() => MODULE_SUITE_TYPE_MAP[currentModule.value] || '')
...
watch(lockedSuiteType, (val) => { filters.suite_type = val }, { immediate: true })
...
const loadTasks = async () => {
  ...
  try {
    ...
    const params = {
      ...
      ...filters,
      ...(lockedSuiteType.value ? { suite_type: lockedSuiteType.value } : {})
    }
